...
public class MetalDetectorItem extends Item {
    ...
    private boolean isOre(BlockState state) {
        return state.is(Blocks.IRON_ORE) || state.is(Blocks.COPPER_ORE) || state.is(Blocks.DIAMOND_ORE) || state.is(Blocks.GOLD_ORE) || state.is(Blocks.LAPIS_ORE) || state.is(Blocks.EMERALD_ORE);
    }
}
